...
task "resque:setup" => :environment do
	...
	require 'twilio_message_handler'

	# Ensure resque logs to separate log file
	Resque.before_fork = Proc.new { 
		puts "WITHIN RESQUE BEFORE_FORK TASK"
		...
		Resque.logger.warn "Resque Logger Initialized!"
	}		
...
#   require "#{root_path}/app/models/smsoperation.rb" #workers
#   require "#{root_path}/app/workers/twilio_message_handler.rb" #workers
